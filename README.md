...
Experimental verification of video using the Epic Labs classifier can be enabled with the `-verifierAddr` flag. Pass in the address of the verifier API:

- `livepeer -broadcaster -verifierAddr http://localhost:5000/verify`
